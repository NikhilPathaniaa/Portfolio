      ...
      <div className="slider-container">
        <Slider {...settings}>
          ...
          <div class="about-box bg-[#fff4f4] dark:bg-transparent">
            <img class="w-10 h-10 object-contain block" src="images/icons/database2.png" alt="icon" />
            <div class="space-y-2">
          ...
          <div class="about-box bg-[#fff4f4] dark:bg-transparent">
            <img class="w-10 h-10 object-contain block" src="images/icons/RestApi.png" alt="icon" />
            <div class="space-y-2">
