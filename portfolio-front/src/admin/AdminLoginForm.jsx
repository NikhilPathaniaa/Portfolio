    ...
    <div className="bg-white lg:rounded-2xl dark:bg-[#111111]">
      ...
      <div className="mx-4 md:mx-[60px] p-4 md:p-16 dark:border-[#212425] dark:border-2 bg-color-810 rounded-xl dark:bg-[#111111] mb-[30px] md:mb-[60px]">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Submit button */}
          <input type="submit" className="px-6 py-2 rounded-lg border-[2px] mt-3 border-color-910 font-semibold cursor-pointer hover:bg-gradient-to-r from-[#FA5252] to-[#DD2476] hover:text-white transition-colors duration-300 ease-in-out hover:border-transparent dark:text-white" />
                <br />
                <br />
                {submitStatus === 'success' && <span style={{ color: 'green' }} className="block mt-2 text-green-500 transform transition-all duration-500 ease-in-out animate-bounce">Please Enter!</span>}
                {submitStatus === 'error' && <span style={{ color: 'red' }} className="block mt-2 text-red-500 transform transition-all duration-500 ease-in-out animate-pulse">🤪 Moye Moye🤪!</span>}
        </form>
