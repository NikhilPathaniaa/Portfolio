    ...
    <div className="col-span-1">
                                    ...
                                    <div className="mb-5">
                                        <div className="flex justify-between mb-1">
                                            <span className=" font-semibold text-[#526377] dark:text-[#A6A6A6]">Spring Boot</span>
                                    ...
                                    <div className="mb-5">
                                        <div className="flex justify-between mb-1">
                                            <span className=" font-semibold text-[#526377] dark:text-[#A6A6A6]">React Js</span>
                                    ...
                                    <div className="mb-5">
                                        <div className="flex justify-between mb-1">
                                            <span
                                                className=" font-semibold text-[#526377] dark:text-[#A6A6A6]">MySQL</span>
                                    ...
                                    <div className="mb-5">
                                        <div className="flex justify-between mb-1">
                                            <span
                                                className=" font-semibold text-[#526377] dark:text-[#A6A6A6]">Restful API's</span>
