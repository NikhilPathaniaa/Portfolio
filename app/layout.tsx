  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="description" content={layoutMetadata.description || "Professional portfolio of Nikhil Pathania, a Full Stack Developer specializing in web development, custom software solutions, and API development."} />
        <meta name="keywords" content={metadata.keywords || "Full Stack Developer, Web Development, Custom Software, API Development, Freelance Developer, Nikhil Pathania"} />
        ...
        <meta property="og:image" content={metadata.openGraph.images[0]?.url || "https://default-image-url.com"} />
        {/* Twitter Card Tags */}
        ...
        <meta name="twitter:image" content={metadata.twitter.image || "https://default-twitter-image-url.com"} />
      </head>
