...
const ContactMe = () => {
  return (
    <div className="pb-12 px-2 sm:px-5 md:px-10 lg:px-14">
      <h3 className="text-[35px] dark:text-white font-bold font-['Roboto_Slab'] pt-5 pb-5">🚀 Let&apos;s Connect! </h3>
      <div className="flex items-center">
        <p className="text-[#44566c] leading-7 mt-2.5 dark:text-color-910  font-['Poppins']">
